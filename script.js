...
function bindLightboxToImages() {
  const clickable = document.querySelectorAll('.waterfall-item img, .mosaic-flex img, .stack-img img, .morning-market img, .circle-item img, .full-image-section img');
...
// Wuhan City Facts
const cityFacts = [
  "?? Wuhan has over 10 bridges across the Yangtze River 每 the First Bridge opened in 1957 with Soviet help.",
  ...
  "?? Wuhan is the heart of China's high-speed rail network 每 you can reach Beijing, Shanghai, Guangzhou within 4-5 hours."
];

const foodFacts = [
  "?? Over 5 million bowls of reganmian are consumed daily in Wuhan 每 that's one for every two citizens!",
  "?? Doupi is made by spreading beaten eggs on a hot pan, then adding sticky rice and fillings 每 it's a breakfast art.",
  "?? Hubu Alley is 150 meters long but houses over 100 food stalls 每 one of China's most concentrated breakfast streets.",
  "?? Wuhan is famous for crayfish (xiaolongxia) 每 in summer, people eat over 1,000 tons per day!",
  "?? Mianwo (fried doughnut) is shaped like a ring with a crispy edge and soft center 每 often dipped in soy milk.",
  "?? Lotus root soup is a winter staple 每 the lotus root grows in the lakes around Wuhan, creating a 'thread' when broken.",
  "??? Wuhan's hot dry noodles use alkaline noodles 每 they are boiled, then cooled with oil to achieve the perfect chew.",
  "?? 'Guozao' culture means people eat breakfast standing, walking, or squatting 每 anything to get that morning fix."
];
