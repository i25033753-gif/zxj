...
// Toast message helper (reused for hover popup)
...
// ========== EXIT BUTTON HOVER POPUP + CLICK FRIENDLY MESSAGE ==========
function initExitButton() {
  ...
  exitBtns.forEach(btn => {
    ...
    // Hover event -> show warm popup (re-encourage to experience Wuhan)
    newBtn.addEventListener('mouseenter', (e) => {
      showToast(" Experience the beauty of Wuhan again! Hot dry noodles, cherry blossoms, and the Yangtze River Bridge are all waiting for you~ ", 2500);
    });
    
    // Click event -> friendly goodbye without any destructive actions
    newBtn.addEventListener('click', (e) => {
      e.preventDefault();
      showToast(" Thank you for exploring Wuhan, and I look forward to meeting you again! May the beauty of the River City always be with you. ", 3000);
    });
  });
}
...
// ========== INITIALIZATION ==========
setTimeout(() => {
  // Random facts init (depends on page)
  ...
  // Setup exit button hover popup & click message
  initExitButton();
  
  // Observe for dynamically added images (like lazy loading)
